...
Route<T> _slideFromLeft<T>(Widget page) => PageRouteBuilder<T>(
    ...
    return Scaffold(
      ...
      drawer: CustomSidebar(
        onPeTap: () {
          ...
          Navigator.push(context, _slideFromLeft(const PePage()));
        },
        onStudentIdTap: () {
          Navigator.of(context).pop();
          Navigator.push(context, _slideFromLeft(const StudentIdPage()));
        },
        onVirtualUniversityTap: () {
          Navigator.of(context).pop();
          Navigator.push(context, _slideFromLeft(const VirtualUniversityPage()));
        },
        onSettingsTap: () {
          Navigator.of(context).pop();
          Navigator.push(context, _slideFromLeft(const SettingsPage()));
        },
        onWhatsNewTap: () async {
          Navigator.of(context).pop();
          final info = await PackageInfo.fromPlatform();
